...
method.trade = function(playerName, oppName, cardNames, oppNames) {
  ...
  var decks = [player.field];
  var oppDecks = [oppPlayer.field];
...
method.findCards = function(cardNames, decks) {
  ...
  decks = [this.field, this.doors, this.dDis, this.treas, this.tDis];
  for (var player of players.values()) {
    decks.push(player.hand);
    decks.push(player.field);
    decks.push(player.classes);
    decks.push(player.races);
    decks.push(player.bonuses);
  }
...
function Player(name, gender) {
  ...
  this.decks = [this.races, this.classes, this.hand, this.field, this.bonuses];
...
method4.trade = function(player2, cards1, cards2) {
  for (var card of cards1.values()) {
    card.setCard(player2.hand);
  }

  for (var card of cards2.values()) {
